...
SYNONYMS = {
    "ланцюг":     ["ланцюжок", "цепочка", "chain", "плетіння", "плетіння ланцюжка", "плетіння ланцюжків"],
    "ланцюжок":   ["ланцюг", "цепочка", "ланцюжки", "ланцюгів", "плетіння", "плетіння ланцюжка"],
    "плетіння":   ["ланцюжок", "ланцюг", "цепочка", "плетіння ланцюжка", "плетіння ланцюжків"],
    ...
    "рамзес":     ["ramzes", "плетіння рамзес", "рамзес ланцюжок"],
    "кардинал":   ["kardinal"],
    "бісмарк":    ["bismark", "плетіння бісмарк"],
    "водоспад":   ["vodopad", "плетіння водоспад"],
    "якірний":    ["якір", "anchor", "плетіння якір", "граненій якір"],
    "візантія":   ["vizantia", "плетіння візантія"],
    "тризуб":     ["trizub", "плетіння тризуб"],
}
